...
class MazeState(AbstractState):
    ...
    def get_neighbors(self, ispart1=False):
        ...
        for idx in neighboring_locs:
            new_state = MazeState(idx, self.goal, self.dist_from_start+1, self.maze, self.mst_cache, self.use_heuristic)
    ...
    def __eq__(self, other):
        return self.state == other.h and self.goal == other.goal
