...
class NeuralNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.layer3(out)
        #print('layer 3 out size: ', out.size())
...
def fit(train_set,train_labels,dev_set,epochs,batch_size=80):
    ...
    train_m = train_set.mean(0,keepdims=True)
    train_s = train_set.std(0, keepdims=True)
    train_set = (train_set - train_m) / train_s
    dev_set = (dev_set - train_m) / train_s
    #epochs=1
    #parameter settings:
